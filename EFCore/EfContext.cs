...
namespace ADO_201.EFCore
{
    public class EfContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(    // UseSqlServer - extension з Microsoft.EntityFrameworkCore.SqlServer
                                            // означає роботу з MS SQL Server / LocalDB
                @"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=ef201ado;Integrated Security=True"
            );
        }
